...
void addRoundKey(int round){
	int i=0;
	for(i;i<16;i++)	
		stateArray[i]^=RoundKey[16*round+i];
...
int main(){
	inputText=takeInput("input.txt");		//read the whole input text file
	...
	writeOutput("encrypted.txt");
	
	//inputForDecryption=takeInput("encrypted.txt");
	inputForDecryption=outputText;
